...
Only requiring some minor changes is digifel.cpp.
...
Changes to digifel.cpp
----------------------
digifel.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
