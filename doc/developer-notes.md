...
Digifel Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9615.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9825 for connections and services them.
...
However, in open source software such as Digifel Core, where everyone uses
...
pay attention to for reviewers of Digifel Core code.

General Digifel Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Digifel Core uses tinyformat, which is type safe. Leave them out to avoid confusion
