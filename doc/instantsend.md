...
This mechanism has been integrated into Bitcore-Node-Digifel which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/digifeldev/insight-api-digifel#web-socket-api](https://github.com/digifeldev/insight-api-digifel#web-socket-api) 
* API: [https://github.com/digifeldev/insight-api-digifel#instantsend-transactions](https://github.com/digifeldev/insight-api-digifel#instantsend-transactions) 
...
By default, the Digifel Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Digifel Core daemon:
