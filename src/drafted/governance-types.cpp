...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "DigifelNetwork") type = DigifelNetwork;
    if(strType == "DigifelNetworkVariable") type = DigifelNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == DigifelNetwork) s = "DigifelNetwork";
    if(type == DigifelNetworkVariable) s = "DigifelNetworkVariable";
