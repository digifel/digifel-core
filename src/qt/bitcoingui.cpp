    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Digifel Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Digifel address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and digifel: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Digifel Core"), this);
    aboutAction->setStatusTip(tr("Show information about Digifel Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Digifel Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Digifel addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Digifel addresses"));
    ...
    openAction->setStatusTip(tr("Open a digifel: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Digifel Core help message to get a list with possible Digifel Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Digifel Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Digifel network", "", count));
}
...
{
    QString strTitle = tr("Digifel Core"); // default title
