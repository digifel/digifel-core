...
{
    if(fLiteMode) return; // ignore all Digifel related functionality
...
/*
    ...
    allow endless transaction that would bloat Digifel and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("digifel-privatesend");
